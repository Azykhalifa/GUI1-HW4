...
using jquery plugins and displays appropriate message to help the user. It also prints the correct
error messages and how to correct them. Sliders are implememted to make the inputs
easier. Also, tables changes live as you update slider input values.
*/
...
function DeleteSingleTable(value){
    ...
    */
  let index = parseInt(value.innerHTML.replace("del",""))-1;
...
function DelteAll(){
    /*
    This function creates a delete all button which allows to delete all saved
    tabs
    */
